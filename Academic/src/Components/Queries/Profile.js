        ...
        <>
          <div className=" my-4 flex w-full justify-center overflow-auto dark:border-slate-500 dark:p-[1px]">
            ...
            <div className="flex flex-col items-start justify-center">
              <h2 className=" whitespace-break-spaces text-2xl font-bold text-white-950  decoration-inherit decoration-2 underline-offset-4 dark:mt-0 dark:text-slate-400 md:text-3xl">
                {user?.name}
              </h2>
              <p className="text-lg capitalize sm:text-xl md:text-1xl">
                {user?.role}
              </p>
            </div>
          </div>
          <div className=" w-full overflow-auto rounded-md border-2 border-slate-400 dark:border-slate-300 dark:p-[1px]">
